public class ArgWrap {
    ...
    public boolean bool() {
	if (_boolean==null) Error.fatal("ArgWrap.bool()");
	return _boolean;
    }

    public int integer() {
	if (_integer==null) Error.fatal("ArgWrap.integer()");
	return _integer;
    }

    public String string() {
	if (_string==null) Error.fatal("ArgWrap.string()");
	return _string;
    }

    public FileRead fileRead() {
	if (_fileRead==null) Error.fatal("ArgWrap.fileRead()");
	return _fileRead;
    }
